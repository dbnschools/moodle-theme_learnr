...
class smartmenus_menus extends \table_sql {
    ...
    public function __construct() {
        ...
        $headers[] = get_string('smartmenusmenutitle', 'theme_learnr');
        $headers[] = get_string('smartmenusmenudescription', 'theme_learnr');
        $headers[] = get_string('smartmenusmenulocation', 'theme_learnr');
        $headers[] = get_string('smartmenusmenutype', 'theme_learnr');
        ...
        $this->count = 0;
        $this->totalmenus = $DB->count_records('theme_learnr_menus');
    }
    ...
    public function col_location($data) {
        ...
        return (!empty($locations)) ? implode(' ', array_map(function($value) {
            $location = \theme_learnr\smartmenu::get_location($value);
    ...
    public function col_type($data) {
        // Get the type.
        $type = \theme_learnr\smartmenu::get_type($data->type);
    ...
    public function col_updown($data) {
        ...
        // Prepare action URL.
        $actionurl = new \moodle_url('/theme/learnr/smartmenus/menus.php');
    ...
    public function col_actions($data) {
        ...
        // Edit.
        $actions[] = [
            'url' => new \moodle_url('/theme/learnr/smartmenus/edit.php', ['id' => $data->id, 'sesskey' => sesskey()]),
        ...
        $actions[] = [
            ...
            'icon' => new \pix_icon('t/copy', get_string('smartmenusmenuduplicate', 'theme_learnr')),
            'attributes' => ['class' => 'action-copy'],
        ];

        // List items.
        $actions[] = [
            'url' => new \moodle_url('/theme/learnr/smartmenus/items.php', ['menu' => $data->id]),
        ...
        $actions[] = [
            ...
            'confirm' => new \confirm_action(get_string('smartmenusmenudeleteconfirm', 'theme_learnr')),
        ];
    ...
    public function print_nothing_to_display() {
        ...
        $notification = new \core\output\notification(
                get_string('smartmenusmenunothingtodisplay', 'theme_learnr'),
