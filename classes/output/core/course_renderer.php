...
if ($PAGE->theme->settings->coursetilestyle < 10) {
    ...
    class course_renderer extends \core_course_renderer {
        ...
        public function view_available_courses($id = 0, $courses = null, $totalcount = null) {
            ...
            $coursetilestyle = $this->page->theme->settings->coursetilestyle;
            $titletooltip = '';
                ...
                foreach ($acourseids as $courseids) {
                    ...
                    foreach ($courseids as $courseid) {
                        ...
                        <div class="col-md-4">';
                            ...
                            $rowcontent .= '
                                    ...
                                    <div class="course-image-view" style="background-image: url(' . $imgurl . ');
                    ...
                    <div class="tilecontainer">
                            <figure class="coursestyle2">
                                <div class="class-box-courseview" style="background-image: url(' . $imgurl . ');
                                    background-repeat: no-repeat;background-size:cover; background-position:center;">
                            ...
                            $rowcontent .= '
                                <figcaption>
                                    ...
                                    ' . $catcontent . '
                                    ' . $customfieldcontent . '
                                    <button type="button" class="btn btn-primary btn-sm coursestyle2btn">' . $enrollbutton .
                        ...
                        if ($coursetilestyle == 3) {
                            ...
                            <div class="col-md-4">
                            <div class="tilecontainer">
                                <div class="class-box-fp-style3" style="background-image: url(' . $imgurl . ');
                                    background-repeat: no-repeat;background-size:cover; background-position:center;">';
                            $rowcontent .= html_writer::start_tag('div', array(
                        ...
                        <div class="col-md-12">
                            <div class="class-fullbox7" style="background-image: url(' . $imgurl . ');
                                background-repeat: no-repeat; background-size:cover; background-position:center;
                                background-color: rgba(0,0,0,0.3); background-blend-mode: overlay;">
                            <div class="fullbox7">
                                ';
                        ...
                        if ($coursetilestyle == 8) {
                            ...
                            $rowcontent .= '<div class="class-box-fp-2col" style="background-image: url(' . $imgurl . ');
                                background-repeat: no-repeat;background-size:cover; background-position:center;">
