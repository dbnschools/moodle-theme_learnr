@theme @theme_learnr @theme_learnr_looksettings @theme_learnr_looksettings_h5p
Feature: Configuring the theme_learnr plugin for the "H5P" tab on the "Look" page
