@theme @theme_learnr @theme_learnr_smartmenusettings @theme_learnr_smartmenusettings_menuitems @theme_learnr_smartmenusettings_menuitems_rules
Feature: Configuring the theme_learnr plugin on the "Smart menus" page, applying different rules to the individual smart menu items
