@theme @theme_learnr @theme_learnr_smartmenusettings @theme_learnr_smartmenusettings_menuitems @theme_learnr_smartmenusettings_menuitems_management
Feature: Configuring the theme_learnr plugin on the "Smart menus" page, managing the individual smart menu items
