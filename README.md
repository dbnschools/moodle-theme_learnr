...
[![Moodle Plugin CI](https://github.com/moodle-an-hochschulen/moodle-theme_learnr/workflows/Moodle%20Plugin%20CI/badge.svg?branch=MOODLE_401_STABLE)](https://github.com/moodle-an-hochschulen/moodle-theme_learnr/actions?query=workflow%3A%22Moodle+Plugin+CI%22+branch%3AMOODLE_401_STABLE)
...
This setting is already available in the Moodle core theme Boost. For more information how to use it, please have a look at the official Moodle documentation: http://docs.moodle.org/en/Boost_theme
Please note: This will not interfere with the setting "theme_learnr | loginbackgroundimage" which means that the pictures uploaded here will be shown on all pages except the login page.
...
http://moodle.org/plugins/view/theme_learnr

The latest development version can be found on Github:
https://github.com/moodle-an-hochschulen/moodle-theme_learnr
...
https://github.com/moodle-an-hochschulen/moodle-theme_learnr/issues
...
https://github.com/moodle-an-hochschulen/moodle-theme_learnr/pulls
