...
// Set page URL.
$PAGE->set_url('/theme/learnr/pages/offers.php');
...
$PAGE->add_body_class('theme_learnr-offers');

// Get theme config.
$config = get_config('theme_learnr');

// If the offers is disabled, we just show a short friendly warning page and are done.
if ($config->enableoffers != THEME_LEARNR_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('offersdisabled', 'theme_learnr'),
...
// Set page title.
$PAGE->set_title(theme_learnr_get_staticpage_pagetitle('offers'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_learnr_get_staticpage_pagetitle('offers'));
