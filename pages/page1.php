...
// Set page URL.
$PAGE->set_url('/theme/learnr/pages/page1.php');
...
$PAGE->add_body_class('theme_learnr-page1');

// Get theme config.
$config = get_config('theme_learnr');

// If the page1 is disabled, we just show a short friendly warning page and are done.
if ($config->enablepage1 != THEME_LEARNR_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('page1disabled', 'theme_learnr'),
...
// Set page title.
$PAGE->set_title(theme_learnr_get_staticpage_pagetitle('page1'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_learnr_get_staticpage_pagetitle('page1'));
