...
function theme_learnr_get_flavour_which_applies() {
    ...
    if ($flavourchecked == true) {
        ...
        if ($previewurl->compare($PAGE->url, URL_MATCH_BASE) == true) {
            ...
            $appliedflavour = $DB->get_record('theme_learnr_flavours', ['id' => $previewflavourid]);
        ...
        $flavours = $DB->get_records('theme_learnr_flavours', [], 'sort ASC');
...
function theme_learnr_flavour_exists_for_cohort($cohortid) {
    ...
    $flavoursforcohorts = $DB->get_records('theme_learnr_flavours', ['applytocohorts' => 1], '', 'applytocohorts_ids');
